    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pages.update", [$page->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $page->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('buttons') ? 'is-invalid' : '' }}" type="text" name="buttons" id="buttons" value="{{ old('buttons', $page->buttons) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content_id" id="content_id">
                    @foreach($contents as $id => $entry)
                        <option value="{{ $id }}" {{ (old('content_id') ? old('content_id') : $page->content->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
