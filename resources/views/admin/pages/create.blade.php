...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="banner">{{ trans('cruds.page.fields.banner') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="image">{{ trans('cruds.page.fields.image') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="buttons">{{ trans('cruds.page.fields.buttons') }}</label>
                <input class="form-control {{ $errors->has('buttons') ? 'is-invalid' : '' }}" type="text" name="buttons" id="buttons" value="{{ old('buttons', '') }}" required>
                @if($errors->has('buttons'))
                    <div class="invalid-feedback">
                        {{ $errors->first('buttons') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.page.fields.buttons_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="content_id">{{ trans('cruds.page.fields.content') }}</label>
                <select class="form-control select2 {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content_id" id="content_id">
