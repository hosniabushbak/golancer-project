    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.abouts.update", [$about->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_1') ? 'is-invalid' : '' }}" type="text" name="image_1" id="image_1" value="{{ old('image_1', $about->image_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_2') ? 'is-invalid' : '' }}" type="text" name="image_2" id="image_2" value="{{ old('image_2', $about->image_2) }}" required>
